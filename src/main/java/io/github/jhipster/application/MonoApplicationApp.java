...
public class MonoApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(MonoApplicationApp.class);

    private final Environment env;

    public MonoApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes monoApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MonoApplicationApp.class);
